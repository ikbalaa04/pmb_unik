...
<div class="login-box">
  ...
  <div class="login-box-body" style="border-radius: 20px" >
    ...
    <form action="<?php echo base_url('home/lupa_password')?>" method="post" class="login-form">
      ...
      <div class="row">
        <div class="col-xs-12"><center>
          <button style="border-radius: 10px" type="submit" class="btn btn-primary btn-block btn-flat"><b>Cek Akun</b></button></center>
        </div>
        <!-- /.col -->
      </div>
    </form>
