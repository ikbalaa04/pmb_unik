    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo site_url(); ?>/manager" class="logo">
          ...
          <span class="logo-mini"><img src="<?php echo base_url('assets/logosm.png')?>" alt="Logo" height="50px" ></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><img src="<?php echo base_url('assets/logounik.png')?>" alt="Logo" height="50px" ></span>
        </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="<?php echo site_url('admin/home/kalkulasi_pendaftar'); ?>"><i class="fa fa-home"></i> <span>PMB</span></a></li>
      ...
      <footer class="main-footer">
        ...
        <strong>&copy; 2024 Universitas Islam KH Ruhiat Cipasung</strong>
      </footer>
