...
echo form_open(base_url('admin/usm/tambah_jadwal_usm'),'class="form-horizontal"');
	...
	<div class="form-group">
	  ...
	  <div class="col-md-5">
	          ...
	          <?php foreach($jenjang as $list_jenjang){ ?>
	            <option value="<?php echo $list_jenjang->nama ?>" <?php if($this->input->post('jenjang')== $list_jenjang->nama ){echo "selected";}?>><?php echo $list_jenjang->nama ?></option>
	          <?php } ?>
	        </select>
	  </div>
	  </div>
...
<select name="gedung" class="form-control" required>
        ...
        <option value="<?php echo $gedung->id?>" <?php if($this->input->post('gedung')== $gedung->id) {echo "selected"; }?> ><?php echo $gedung->nama?></option>
        <?php } ?>
        </select><!--  -->
    </div>
    </div>
...
<select name="jenis_ujin" class="form-control" required>
        ...
        <option value="<?php echo $jenis->id?>" <?php if($this->input->post('jenis_ujin')== $jenis->id) {echo "selected"; }?> ><?php echo $jenis->nama?></option>
        <?php } ?>
        </select>
    </div>
    </div>
...
<div class="form-group">
	...
	<div class="col-md-5">
		<input type="text" id="tanggal"  name="tgl_ujian" class="form-control" value="<?php echo set_value('tgl_ujian')?>" required>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-md-5">
		<input type="time" name="jam_mulai" class="form-control" value="<?php echo set_value('jam_mulai')?>" required>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-md-5">
		<input type="text" name="jam_selesai" class="form-control" value="<?php echo set_value('jam_selesai')?>" required>
	</div>
</div>
