...
<?php  
    ...
    $filename = "Data PMB Terverifikasi $fakultas_hadir->nama_fakultas $fakultas_hadir->nama_gelombang $pilihan1->jenjang $pilihan1->nama Tahun Angkatan $fakultas_hadir->angkatan .xls";
...
<h3>Data Penerimaan Mahasiswa Baru Terverifikasi <?php echo $fakultas_hadir->nama_fakultas ?> <?php echo $fakultas_hadir->nama_gelombang ?> <?php echo $pilihan1->jenjang ?> <?php echo $pilihan1->nama ?> Tahun Angkatan <?php echo $fakultas_hadir->angkatan ?></h3>
