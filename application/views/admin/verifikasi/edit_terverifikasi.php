...
<div class="form-group">
	...
	<div class="col-md-9">
		<input type="text" name="npsn" class="form-control" value="<?php echo $detail->npsn ?>" >
	</div>
</div>
...
<div class="form-group">
	<label class="col-md-3 control-label">Asal Kampus</label>
	<div class="col-md-9">
		<input style="text-transform: capitalize;" type="text" name="pindahan_namapt" class="form-control"  value="<?php echo $detail->pindahan_namapt ?>">
	</div>
</div>
