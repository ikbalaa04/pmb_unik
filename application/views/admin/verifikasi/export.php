...
<?php  
    ...
    $filename = "Data PMB Sudah Bayar Belum Terverifikasi $fakultas_hadir->nama_fakultas $fakultas_hadir->nama_gelombang $pilihan1->jenjang $pilihan1->nama Tahun Angkatan $fakultas_hadir->angkatan .xls";
...
<h3>Daftar Mahasiswa Baru Sudah Bayar Belum Terverifikasi <?php echo $fakultas_hadir->nama_fakultas ?> <br><?php echo $fakultas_hadir->nama_gelombang ?> <?php echo $pilihan1->jenjang ?> <?php echo $pilihan1->nama ?> Tahun Angkatan <?php echo $fakultas_hadir->angkatan ?></h3>
