<button type="button" class="btn btn-sm btn-xs btn-info" data-toggle="modal" data-target="#Detail-<?php echo $verifikasi->id?>">
              ...
              <div class="modal-body">
              	<table id="example1" class="table table-bordered table-striped">
                    ...
                    <tr>
                      ...
                      <td>:</td>
                      <td><center><img src="<?php echo base_url('assets/upload/bukti/thumbs/'.$verifikasi->bukti_bayar)?>" class="img img-responsive img-thumbnail" width="100%"><br><br>
