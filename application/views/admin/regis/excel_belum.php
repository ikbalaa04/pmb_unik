...
<?php  
    ...
    $filename = "Data Peserta Lulus Belum Registrasi Ulang $fakultas_hadir->nama_fakultas $fakultas_hadir->nama_gelombang $pilihan1->jenjang $pilihan1->nama Tahun Angkatan $fakultas_hadir->angkatan .xls";
...
<h3>Data Peserta Lulus Belum Registrasi Ulang <?php echo $fakultas_hadir->nama_fakultas ?> <?php echo $pilihan1->jenjang ?> <?php echo $pilihan1->nama ?>  <?php echo $fakultas_hadir->nama_gelombang ?></h3>
