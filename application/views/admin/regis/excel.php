...
<?php  
    ...
    $filename = "Data Peserta Lulus Sudah Registrasi Ulang $fakultas_hadir->nama_fakultas $fakultas_hadir->nama_gelombang $pilihan1->jenjang $pilihan1->nama Tahun Angkatan $fakultas_hadir->angkatan .xls";
...
<h3>Data Peserta Lulus Sudah Registrasi Ulang <?php echo $fakultas_hadir->nama_fakultas ?> <?php echo $pilihan1->jenjang ?> <?php echo $pilihan1->nama ?>  <?php echo $fakultas_hadir->nama_gelombang ?></h3>

<table id="example1" class="table table-bordered table-striped" border="1">
    <thead>
        <tr>
            <th>No</th> 
            <th>Status Verifikasi Registrasi Ulang</th>
            <th>Username</th>
            <th>No. Ujian</th>
            <th>Sumber</th>
            <th>NIK</th>
