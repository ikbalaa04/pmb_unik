...
<?php  
    ...
    $filename = "Data PMB Belum Bayar $fakultas_hadir->nama_fakultas $fakultas_hadir->nama_gelombang $pilihan1->jenjang $pilihan1->nama Tahun Angkatan $fakultas_hadir->angkatan .xls";
...
<h3>Daftar Mahasiswa Baru yang Belum Bayar <?php echo $fakultas_hadir->nama_fakultas ?> <br><?php echo $fakultas_hadir->nama_gelombang ?> <?php echo $pilihan1->jenjang ?> <?php echo $pilihan1->nama ?> Tahun Angkatan <?php echo $fakultas_hadir->angkatan ?></h3>
