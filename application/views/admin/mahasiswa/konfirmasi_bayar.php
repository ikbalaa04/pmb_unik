...
<?php if($detail->valid_lanjutan == "1"){ ?>

  <div class="col-md-6">
  <p>2. Jika sudah melakukan pembayaran silahkan isi form berikut :
  <?php echo form_open_multipart(base_url('admin/home/konfirmasi_bayar/'),'class="form-horizontal"'); ?>
...
<div class="col-md-12">
  <p>3. Selanjutnya silahkan melakukan konfirmasi pembayaran ke nomor whatsapp berikut supaya pembayaran segera diverifikasi admin <a class="btn btn-xs btn-success" style="border-radius: 10px" target="_blank" href="https://api.whatsapp.com/send?phone=<?php echo $detail_institusi->wa_konfirmasi ?>"> <i class="fa fa-whatsapp"></i> <b>ADMIN KEUANGAN</b> </a></p>

</div>

<?php }else{ ?>
  <div class="col-md-12">
  <div class="alert alert-danger">Anda belum bisa upload bukti registrasi pendaftaran jika data - data pada menu Data Calon Mahasiswa belum dilengkapi, Silahkan lengkapi terlebih dahulu semua datanya ! <a class="btn btn-xs btn-success" href="<?php echo base_url('admin/home/isi_form')?>"><b>Disini</b></a></div>
 </div>
<?php } ?>
