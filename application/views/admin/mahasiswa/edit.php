...
<div class="row">
<?php echo form_open_multipart(base_url('admin/home/mahasiswa/'),'class="form-horizontal"'); ?>
...
<div class="form-group">
	...
	<div class="col-md-9">
		<input type="text" disabled="" name="nisn" class="form-control" value="<?php echo $detail->nisn ?>" >
	</div>
</div>
<?php } ?>
	...
	<div class="col-md-9">
		<select disabled="" name="gelombang" class="form-control">
	        <option selected disabled>-Pilih-</option>
	        	...
	        	<option value="<?php echo $pilih_gelombang->id?>" <?php if($detail->gelombang ==$pilih_gelombang->id){echo "selected";} ?>><?php echo $pilih_gelombang->singkatan?> - <?php echo $pilih_gelombang->nama?> - <?php echo $pilih_gelombang->tahun?> - <?php echo $pilih_gelombang->keterangan?></option>
	            <?php } ?>
	        </select>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-md-9">
	<select disabled="" name="program" class="form-control">
        <option selected disabled>-Pilih-</option>
...
<div class="form-group">
	...
	<div class="col-md-9">
		<select disabled="" name="jenis" class="form-control">
        <option selected disabled>-Pilih-</option>
...
<div class="form-group">
	...
	<select disabled="" name="prodi[0]" class="form-control">
...
<div class="form-group">
	...
	<div class="col-md-9">
	<select disabled="" name="prodi[1]" class="form-control">
        <option value="0">-Pilih-</option>
