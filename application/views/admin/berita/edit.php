...
echo form_open_multipart(base_url('admin/home/edit_berita/'.$detail_berita->id_berita),'class="form-horizontal"');
...
<div class="form-group">
	...
	<div class="col-md-5">
		<select name="kategori" class="form-control">
			...
			<option value="Pengumuman" <?php if($detail_berita->kategori=='Pengumuman'){echo "selected";}?>>Pengumuman</option>
			<option value="Informasi" <?php if($detail_berita->kategori=='Informasi'){echo "selected";}?>>Informasi</option>
	</select>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-md-10">
		<textarea class="ckeditor" id="ckedtor" name="isi_berita" required><?php echo $detail_berita->isi_berita ?></textarea>
	</div>
</div>
