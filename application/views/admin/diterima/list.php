<div class="row" align="text-center"> 
    <form method="post" action="<?php echo base_url('admin/home/diterima_filter')?>">
        ...
        <a class="btn btn-primary btn-md" style="margin-top: 5px; border-radius: 5px" href="<?php echo base_url('admin/home/export_pendaftaran_excel/diterima')?>"><i class="fa fa-file-excel-o"></i> Export Excel</a>
    </form>
</div><br>
