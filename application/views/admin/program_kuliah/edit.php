...
echo form_open(base_url('admin/home/edit_program_kuliah/'.$list->id),'class="form-horizontal"');
...
<div class="form-group">
  ...
  <div class="col-md-10">
    <select name="tipe_program" required="" class="form-control">
      <option value="">-Pilih-</option>
      <option value="Berbayar" <?php if($list->tipe_program=='Berbayar'){echo "selected";}?>>Berbayar</option>
      <option value="Gratis" <?php if($list->tipe_program=='Gratis'){echo "selected";}?>>Gratis</option>
  </select>
  </div>
</div>
