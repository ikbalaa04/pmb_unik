            ...
            <div class="login-box-body">
              <p class="login-box-msg">Masukkan Username dan Password</p>
                ...
                <div class="form-group has-feedback">
                  <input type="text" id="username" autocomplete="off" name="username" value="<?php echo $username ?>" class="form-control" placeholder="Username"/>
                  <span class="glyphicon glyphicon-user form-control-feedback"></span>
                </div>
              <div class="form-group has-feedback">
                <input type="password" id="password" autocomplete="off" name="password" value="<?php echo $password ?>" class="form-control" placeholder="Password"/>
