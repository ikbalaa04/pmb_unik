      ...
      <div class="header-container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
          <ul>
            ...
            <li><a class="nav-link scrollto" href="<?php echo base_url('home/lebih_berita') ?>">Informasi</a></li>
            
            <li><a class="nav-link scrollto " href="#portfolio">Galeri</a></li>
            <li><a class="nav-link scrollto" href="<?php echo base_url('home/kelulusan') ?>">Kelulusan</a></li>
            <li><a class="nav-link scrollto" href="#testimonials">Pendaftar</a></li>
            ...
            <!-- <li><a class="nav-link scrollto" href="<?php echo base_url('home/lebih_biaya') ?>">Biaya</a></li> -->
