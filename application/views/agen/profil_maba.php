...
<header class="section-header"><br><br><br>
    ...
    <div class="row">
    <div class="col-md-12 col-lg-12"><a href="<?php echo base_url('agen/profil')?>" class="btn btn-primary btn-xs pull-left"><i class="fa fa-reply-all"></i> Kembali</a> <a href="<?php echo base_url('agen/list_mahasiswa')?>" class="btn btn-success btn-xs pull-right"><i class="fa fa-users"></i> Riwayat Pendaftaran</a>
    </div>
    <div class="col-md-12 col-lg-12"><br><br></div>
      <div class="col-md-12 col-lg-12 wow bounceInUp" data-wow-duration="1.4s">
        <div class="box">
        <h4 align="left">Menu Mahasiswa <hr></h4>
          <table width="100%">
            <tbody >
            ...
            <tr><td align="left"><a class="btn btn-default" href="<?php echo base_url('agen/cetak_kartu/'.$detail->id)?>"><i class="fa fa-vcard"></i> Cetak Kartu</a></td>
            </tr> 

            <?php }else{ ?>

            <tr><td align="left"><a href="#" class="btn btn-default" ><i class="fa fa-vcard"></i> Cetak Kartu</a></td>
            </tr>
            ...
            <tr><td align="left"><a class="btn btn-default" href="<?php echo base_url('agen/konfirmasi_pembayaran/'.$detail->id)?>"><i class="fa fa-money"></i> Konfirmasi Pembayaran</a></td>
            </tr>

            <tr><td align="left"><a class="btn btn-default" href="<?php echo base_url('agen/upload_berkas/'.$detail->id)?>"><i class="fa fa-book"></i> Upload Berkas</a></td>
            </tr>
            ...
            <div class="box" style="text-align: left;">
                ...
                <?php if($detail->bayar == 1) { ?>

                    <marquee direction="left" scrollamount="6" height="50" align="center">
                        <b style="color: blue">Terimakasih telah melakukan konfirmasi pembayaran silahkan lengkapi data dan tunggu verifikasi kami dalam 1x24 jam</b>
                     </marquee>
                ...
                <?php if($detail->approve == 1) { ?>
                    ...
                    <marquee direction="left" scrollamount="6" height="50" align="center">
                        <b style="color: green">Selamat status konfirmasi pembayaran anda telah kami verifikasi, silahkan cetak kartu ujian / formulir setelah kami siapkan nomer ujian </b>
                     </marquee>
          ...
          <?php     
            ...
            $pilih_fakultas     = $this->admin_model->pilih_gelombang_user($fakultas);
            $pilih_fakultas_2    = $this->admin_model->pilih_gelombang_user2($fakultas2);
          ...
          <div class="col-md-12  wow bounceInUp" data-wow-duration="1.4s">
            <div class="box" >
            <br>
            <b>Data Calon Mahasiswa Baru</b><hr>
            <div class="rspv-tabel">
            <table cellspacing="5" cellpadding="5">
                <tbody>
                    <tr><td width="200" align="left"> Fakultas 1</td>
                        <td width="10">:&emsp;</td>
                        <td width="800" align="left"><select disabled="" name="gelombang" class="form-control">
                            <option selected disabled>-Pilih-</option>
                                <?php foreach($pilih_fakultas as $pilih_fakultas) {?>
                                <option value="<?php echo $pilih_fakultas->id?>" <?php if($detail->gelombang ==$pilih_fakultas->id){echo "selected";} ?>><?php echo $pilih_fakultas->nama_fakultas ?></option>
                                <?php } ?>
                            </select>
                        </td>
                    </tr>

                    <tr><td width="200" align="left"> Gelombang 1</td>
                        <td width="10">:&emsp;</td>
                        <td width="800" align="left"><select disabled="" name="gelombang" class="form-control">
                            <option selected disabled>-Pilih-</option>
                                <?php foreach($pilih_gelombang as $pilih_gelombang) {?>
                                <option value="<?php echo $pilih_gelombang->id?>" <?php if($detail->gelombang ==$pilih_gelombang->id){echo "selected";} ?>> <?php echo $pilih_gelombang->nama?></option>
                                <?php } ?>
                            </select>
                        </td>
                    </tr>

                    <tr><td width="200" align="left"> Pilihan 1</td>
                        <td width="10">:&emsp;</td>
                        <td align="left">
                    ...
                    <tr><td width="200" align="left">Fakultas 2</td>
                        <td width="10">:&emsp;</td>
                        <td align="left">
                        <select disabled="" class="form-control">
                            <option selected disabled>-Pilih-</option>
                                <?php foreach($pilih_fakultas_2 as $pilih_fakultas_2) {?>
                                <option value="<?php echo $pilih_fakultas_2->id?>" <?php if($detail->gelombang_2 ==$pilih_fakultas_2->id){echo "selected";} ?>><?php echo $pilih_fakultas_2->nama_fakultas ?></option>
                                <?php } ?>
                            </select>
                        </td>
                    </tr>

                    <tr><td width="200" align="left">Gelombang 2</td>
                        <td width="10">:&emsp;</td>
                        <td align="left">
                        <select disabled="" class="form-control">
                            <option selected disabled>-Pilih-</option>
                                <?php foreach($pilih_gelombang_2 as $pilih_gelombang_2) {?>
                                <option value="<?php echo $pilih_gelombang_2->id?>" <?php if($detail->gelombang_2 ==$pilih_gelombang_2->id){echo "selected";} ?>> <?php echo $pilih_gelombang_2->nama?></option>
                                <?php } ?>
                            </select>
                        </td>
                    </tr>

                    <tr><td width="200" align="left"> Pilihan 2</td>
                        <td width="10">:&emsp;</td>
                        <td align="left"><select name="jurusan_pilihan2" disabled="" class="form-control">
                        <option value="">-Pilih-</option>
                            <?php   
                    ...
                    <tr><td width="200" align="left"> Email</td>
                        <td width="10">:&emsp;</td>
                        <td align="left"><?php echo $detail->email?></td>
                    </tr>

                    <?php if($detail->noujian != '') { ?>
                    <tr><td width="200" align="left"> Nomor Ujian</td>
                        <td width="10">:&emsp;</td>
                        <td align="left"><?php echo $detail->noujian?></td>
                    </tr>
                    <?php }else{ ?>
                    <tr><td width="200" align="left"> Nomor Ujian</td>
                        <td width="10">:&emsp;</td>
                        <td align="left">Belum Ada Nomor Ujian</td>
                    </tr>
                    <?php } ?>
                </tbody>
                </table> 
        ...
        <form action="<?php echo base_url('agen/profil_maba/'.$detail->id)?>" method="post" >
        <div class="col-md-12 wow bounceInUp" data-wow-duration="1.4s">
        <div class="box">
            <?php
              echo validation_errors('<div class="alert alert-warning">','</div>');
            ...
            <div class="col-md-6">
              <?php if($detail->jenis=='MB') { ?>
                <?php if($detail->jenjang=='S2' || $detail->jenjang=='S3' || $detail->jenjang=='Profesi') { ?>
                    ...
                    <div class=" ">
                        <?php if($detail->kampus_asal!=''){?>
                        <input type="text" name="kampus_asal" class="form-control" value="<?php echo $detail->kampus_asal ?>">
                        <?php }else{?>
                        <input type="text" name="kampus_asal" class="form-control"  value="<?php echo $this->input->post('kampus_asal') ?>">
                        <?php }?>
                    </div>
                ...
                <?php }else{ ?>
                    ...
                    <label class="  ">Asal Jurusan</label>
                    <div class=" ">
                        <select name="sekolah_jurusan" class="form-control">
                            ...
                            <?php }else{?>
                            <option value="IPA" <?php if($this->input->post('sekolah_jurusan') == 'IPA'){echo "selected";} ?>>IPA</option>
                            <option value="IPS" <?php if($this->input->post('sekolah_jurusan') == 'IPS'){echo "selected";} ?>>IPS</option>
                            <option value="Lainnya" <?php if($this->input->post('sekolah_jurusan') == 'Lainnya'){echo "selected";} ?>>Lainnya</option>
                            <?php }?>
                            
                        </select>
                    </div>

                <?php if($detail->sekolah_jurusan=='IPA' || $detail->sekolah_jurusan=='IPS'){?>
                <?php }else{?>
                 
                    <label class="  ">Nama Jurusan <small style="color: red">(Nama Jurusan jika memilih jurusan <b style="color: blue">Lainnya</b>)</small></label>
                    <div class=" ">
                        <?php if($detail->sekolah_nama_jurusan!=''){?>
                        <input type="text" name="sekolah_nama_jurusan" class="form-control"  value="<?php echo $detail->sekolah_nama_jurusan ?>">
                        <?php }else{?>
                        <input type="text" name="sekolah_nama_jurusan" class="form-control"  value="<?php echo $this->input->post('sekolah_nama_jurusan') ?>">
                        <?php }?>
                    </div>
                <?php }?>
